...
public class C01_DataCasting {
    ...
    public static void main(String[] args) {
        ...
        int sayi1 = (int) 7.3;                 // bazen bir variebla'a olusturuldugu data turu dısından deger atanabilir
        System.out.println("sayi1= " + sayi1);// 7 bunlardan bazisini java otomatik olarak kabul eder..
        double sayi2 = 10;
